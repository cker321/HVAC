.class public final Lcom/dnake/desktop/controller/SettingControllerInfoUpdateHandler;
.super Lcom/yanzhenjie/andserver/framework/handler/MappingHandler;
.source "SettingControllerInfoUpdateHandler.java"
...
.method public constructor <init>(Ljava/lang/Object;Lcom/yanzhenjie/andserver/framework/mapping/Mapping;Lcom/yanzhenjie/andserver/framework/mapping/Addition;Lcom/yanzhenjie/andserver/framework/cross/CrossOrigin;)V
    ...
    .line 30
    iput-object p1, p0, Lcom/dnake/desktop/controller/SettingControllerInfoUpdateHandler;->mHost:Ljava/lang/Object;
...
.method protected onHandle(Lcom/yanzhenjie/andserver/http/HttpRequest;Lcom/yanzhenjie/andserver/http/HttpResponse;)Lcom/yanzhenjie/andserver/framework/view/View;
    ...
    .line 55
    :cond_2
    invoke-virtual {p0, p2}, Lcom/dnake/desktop/controller/SettingControllerInfoUpdateHandler;->getPathVariable(Ljava/lang/String;)Ljava/util/Map;

    .line 58
    iget-object p1, p0, Lcom/dnake/desktop/controller/SettingControllerInfoUpdateHandler;->mHost:Ljava/lang/Object;

    check-cast p1, Lcom/dnake/desktop/controller/SettingController;

    invoke-virtual {p1}, Lcom/dnake/desktop/controller/SettingController;->infoUpdate()Lcom/dnake/desktop/bean/RegisterInfo;
