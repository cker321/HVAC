...
import org.apache.commons.p006io.ByteOrderMark;
...
public class XmlStreamReader extends Reader {
    ...
    private String doLenientDetection(String str, XmlStreamReaderException xmlStreamReaderException) throws IOException {
        if (str != null && str.startsWith(MediaType.TEXT_HTML_VALUE)) {
            try {
    ...
    String calculateRawEncoding(String str, String str2, String str3) throws IOException {
        if (str == null) {
            if (str2 != null && str3 != null) {
                return (str3.equals("UTF-16") && (str2.equals(UTF_16BE) || str2.equals(UTF_16LE))) ? str2 : str3;
            }
    ...
    static boolean isAppXml(String str) {
        return str != null && (str.equals(MediaType.APPLICATION_XML_VALUE) || str.equals("application/xml-dtd") || str.equals("application/xml-external-parsed-entity") || (str.startsWith("application/") && str.endsWith("+xml")));
    }

    static boolean isTextXml(String str) {
        return str != null && (str.equals(MediaType.TEXT_XML_VALUE) || str.equals("text/xml-external-parsed-entity") || (str.startsWith("text/") && str.endsWith("+xml")));
    }
}
