...
public class FileSystemUtils {
    ...
    /* renamed from: DF */
    private static final String f283DF;
    private static final int INIT_PROBLEM = -1;
    private static final FileSystemUtils INSTANCE = new FileSystemUtils();

    /* renamed from: OS */
    private static final int f284OS;
    ...
    public static long freeSpace(String str) throws IOException {
        return INSTANCE.freeSpaceOS(str, f284OS, false, -1L);
    }
    ...
    public static long freeSpaceKb(String str, long j) throws IOException {
        return INSTANCE.freeSpaceOS(str, f284OS, true, j);
    }
    ...
    long freeSpaceWindows(String str, long j) throws Throwable {
        ...
        List<String> listPerformCommand = performCommand(new String[]{"cmd.exe", "/C", "dir /a /-c " + strNormalize}, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, j);
    ...
    long freeSpaceUnix(String str, boolean z, boolean z2, long j) throws Throwable {
        ...
        List<String> listPerformCommand = performCommand(str2.length() > 1 ? new String[]{f283DF, str2, str} : new String[]{f283DF, str}, 3, j);
        if (listPerformCommand.size() < 2) {
            throw new IOException("Command line '" + f283DF + "' did not return info as expected for path '" + str + "'- response was " + listPerformCommand);
        }
        ...
        if (stringTokenizer.countTokens() < 4) {
            if (stringTokenizer.countTokens() == 1 && listPerformCommand.size() >= 3) {
                ...
                throw new IOException("Command line '" + f283DF + "' did not return data as expected for path '" + str + "'- check path is valid");
            }
        } else {
    ...
    long parseBytes(String str, String str2) throws NumberFormatException, IOException {
        try {
            ...
            throw new IOException("Command line '" + f283DF + "' did not find free space in response for path '" + str2 + "'- check path is valid");
        } catch (NumberFormatException e) {
            throw new IOException("Command line '" + f283DF + "' did not return numeric data as expected for path '" + str2 + "'- check path is valid", e);
        }
    }
    ...
    */
    java.util.List<java.lang.String> performCommand(java.lang.String[] r11, int r12, long r13) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.p006io.FileSystemUtils.performCommand(java.lang.String[], int, long):java.util.List");
    }
