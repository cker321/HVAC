...
public class VersionInfo {
    ...
    public static VersionInfo loadVersionInfo(String str, ClassLoader classLoader) throws IOException {
        ...
        try {
            resourceAsStream = classLoader.getResourceAsStream(str.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX) + MqttTopic.TOPIC_LEVEL_SEPARATOR + VERSION_PROPERTY_FILE);
