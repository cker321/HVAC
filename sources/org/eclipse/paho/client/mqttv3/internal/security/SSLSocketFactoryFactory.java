...
public class SSLSocketFactoryFactory {
    ...
    public static char[] deObfuscate(String str) {
        ...
        try {
            ...
            for (int i = 0; i < bArrDecode.length; i++) {
                byte b = bArrDecode[i];
                byte[] bArr = key;
                bArrDecode[i] = (byte) ((b ^ bArr[i % bArr.length]) & 255);
            }
    ...
    private SSLContext getSSLContext(String str) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException, KeyManagementException, NoSuchProviderException, MqttSecurityException {
    ...
    public SSLSocketFactory createSocketFactory(String str) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, CertificateException, KeyManagementException, NoSuchProviderException, MqttSecurityException {
