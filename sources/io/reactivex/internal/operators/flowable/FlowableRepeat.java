...
public final class FlowableRepeat<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class RepeatSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* renamed from: sa */
        final SubscriptionArbiter f196sa;
        ...
        RepeatSubscriber(Subscriber<? super T> subscriber, long j, SubscriptionArbiter subscriptionArbiter, Publisher<? extends T> publisher) {
            ...
            this.f196sa = subscriptionArbiter;
        ...
        public void onSubscribe(Subscription subscription) {
            this.f196sa.setSubscription(subscription);
        }
        ...
        void subscribeNext() {
            if (getAndIncrement() == 0) {
                int iAddAndGet = 1;
                while (!this.f196sa.isCancelled()) {
                    long j = this.produced;
                    if (j != 0) {
                        this.produced = 0L;
                        this.f196sa.produced(j);
                    }
