...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, NumberFormatException, UnknownHostException {
        ...
        int i = C08181.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parseResult.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i == 2) {
    ...
    public static final class Builder {
        ...
        ParseResult parse(@Nullable HttpUrl httpUrl, String str) throws NumberFormatException {
