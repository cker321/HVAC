...
public final class Http2Codec implements HttpCodec {
    ...
    /* renamed from: TE */
    private static final ByteString f275TE = ByteString.encodeUtf8("te");
    private static final ByteString ENCODING = ByteString.encodeUtf8("encoding");

    static {
        ByteString byteStringEncodeUtf8 = ByteString.encodeUtf8("upgrade");
        UPGRADE = byteStringEncodeUtf8;
        HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList(CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, f275TE, TRANSFER_ENCODING, ENCODING, byteStringEncodeUtf8, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY);
        HTTP_2_SKIPPED_RESPONSE_HEADERS = Util.immutableList(CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, f275TE, TRANSFER_ENCODING, ENCODING, UPGRADE);
    }
