...
public class ViewCompat {
    ...
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0159R.id.accessibility_custom_action_0, C0159R.id.accessibility_custom_action_1, C0159R.id.accessibility_custom_action_2, C0159R.id.accessibility_custom_action_3, C0159R.id.accessibility_custom_action_4, C0159R.id.accessibility_custom_action_5, C0159R.id.accessibility_custom_action_6, C0159R.id.accessibility_custom_action_7, C0159R.id.accessibility_custom_action_8, C0159R.id.accessibility_custom_action_9, C0159R.id.accessibility_custom_action_10, C0159R.id.accessibility_custom_action_11, C0159R.id.accessibility_custom_action_12, C0159R.id.accessibility_custom_action_13, C0159R.id.accessibility_custom_action_14, C0159R.id.accessibility_custom_action_15, C0159R.id.accessibility_custom_action_16, C0159R.id.accessibility_custom_action_17, C0159R.id.accessibility_custom_action_18, C0159R.id.accessibility_custom_action_19, C0159R.id.accessibility_custom_action_20, C0159R.id.accessibility_custom_action_21, C0159R.id.accessibility_custom_action_22, C0159R.id.accessibility_custom_action_23, C0159R.id.accessibility_custom_action_24, C0159R.id.accessibility_custom_action_25, C0159R.id.accessibility_custom_action_26, C0159R.id.accessibility_custom_action_27, C0159R.id.accessibility_custom_action_28, C0159R.id.accessibility_custom_action_29, C0159R.id.accessibility_custom_action_30, C0159R.id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0159R.id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0159R.id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.ViewCompat.1
                    ViewOnApplyWindowInsetsListenerC01861() {
                    }
    ...
    class ViewOnApplyWindowInsetsListenerC01861 implements View.OnApplyWindowInsetsListener {
        ViewOnApplyWindowInsetsListenerC01861() {
        }
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0159R.id.tag_unhandled_key_listeners);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(C0159R.id.tag_unhandled_key_listeners, simpleArrayMap);
            }
            ViewOnUnhandledKeyEventListenerC01872 viewOnUnhandledKeyEventListenerC01872 = new View.OnUnhandledKeyEventListener() { // from class: androidx.core.view.ViewCompat.2
                ViewOnUnhandledKeyEventListenerC01872() {
                }
            ...
            simpleArrayMap.put(onUnhandledKeyEventListenerCompat, viewOnUnhandledKeyEventListenerC01872);
            view.addOnUnhandledKeyEventListener(viewOnUnhandledKeyEventListenerC01872);
            return;
        }
        ArrayList arrayList = (ArrayList) view.getTag(C0159R.id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0159R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    class ViewOnUnhandledKeyEventListenerC01872 implements View.OnUnhandledKeyEventListener {
        ViewOnUnhandledKeyEventListenerC01872() {
        }
    ...
    class C01883 extends AccessibilityViewProperty<Boolean> {
        C01883(int i, Class cls, int i2) {
            super(i, cls, i2);
        }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0159R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.3
            C01883(int i, Class cls, int i2) {
                super(i, cls, i2);
            }
    ...
    class C01894 extends AccessibilityViewProperty<CharSequence> {
        C01894(int i, Class cls, int i2, int i3) {
            super(i, cls, i2, i3);
        }
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0159R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.4
            C01894(int i, Class cls, int i2, int i3) {
                super(i, cls, i2, i3);
            }
    ...
    class C01905 extends AccessibilityViewProperty<Boolean> {
        C01905(int i, Class cls, int i2) {
            super(i, cls, i2);
        }
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0159R.id.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.5
            C01905(int i, Class cls, int i2) {
                super(i, cls, i2);
            }
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m6at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0159R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0159R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
