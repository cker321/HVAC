...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void animateToTab(int i) {
        ...
        RunnableC01001 runnableC01001 = new Runnable() { // from class: androidx.appcompat.widget.ScrollingTabContainerView.1
            final /* synthetic */ View val$tabView;

            RunnableC01001(View childAt2) {
                view = childAt2;
            }
        ...
        this.mTabSelector = runnableC01001;
        post(runnableC01001);
    }
