...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    class RunnableC03322 implements Runnable {
        RunnableC03322() {
        }
    ...
    static class InterpolatorC03333 implements Interpolator {
        @Override // android.animation.TimeInterpolator
        public float getInterpolation(float f) {
            float f2 = f - 1.0f;
            return (f2 * f2 * f2 * f2 * f2) + 1.0f;
    ...
    class C03344 implements ViewInfoStore.ProcessCallback {
        C03344() {
        }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) throws NoSuchMethodException, SecurityException {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0301R.styleable.RecyclerView, i, 0);
            String string = typedArrayObtainStyledAttributes2.getString(C0301R.styleable.RecyclerView_layoutManager);
            if (typedArrayObtainStyledAttributes2.getInt(C0301R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            boolean z2 = typedArrayObtainStyledAttributes2.getBoolean(C0301R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z2;
            if (z2) {
                initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(C0301R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(C0301R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(C0301R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(C0301R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    class C03355 implements ChildHelper.Callback {
        C03355() {
        }
    ...
    class C03366 implements AdapterHelper.Callback {
        C03366() {
        }
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:186:0x0188 A[PHI: r1 r4
          0x0188: PHI (r1v12 androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
          (r1v11 androidx.recyclerview.widget.RecyclerView$ViewHolder)
          (r1v31 androidx.recyclerview.widget.RecyclerView$ViewHolder)
         binds: [B:141:0x005d, B:172:0x0102] A[DONT_GENERATE, DONT_INLINE]
          0x0188: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:141:0x005d, B:172:0x0102] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        /* JADX WARN: Removed duplicated region for block: B:219:0x0231 A[ADDED_TO_REGION] */
    ...
    public static abstract class LayoutManager {
        ...
        class C03371 implements ViewBoundsCheck.Callback {
            C03371() {
            }
        ...
        class C03382 implements ViewBoundsCheck.Callback {
            C03382() {
            }
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0301R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C0301R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C0301R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C0301R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C0301R.styleable.RecyclerView_stackFromEnd, false);
            typedArrayObtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0301R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0301R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0301R.dimen.fastscroll_margin));
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03391 implements Parcelable.ClassLoaderCreator<SavedState> {
            C03391() {
            }
