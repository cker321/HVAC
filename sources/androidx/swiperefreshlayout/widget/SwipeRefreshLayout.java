...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    */
    ...
    private void moveSpinner(float f) {
        ...
        Double.isNaN(dMax);
        float f3 = ((float) (dMax - dPow)) * DECELERATE_INTERPOLATION_FACTOR;
        int i2 = this.mOriginalOffsetTop + ((int) ((f2 * fMin) + (f2 * f3 * DECELERATE_INTERPOLATION_FACTOR)));
        ...
        this.mProgress.setProgressRotation((((fMax * 0.4f) - 0.25f) + (f3 * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
