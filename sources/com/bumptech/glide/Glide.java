...
public class Glide implements ComponentCallbacks2 {
    ...
    private static void initializeGlide(Context context, GlideBuilder glideBuilder) {
        ...
        while (it4.hasNext()) {
            it4.next().registerComponents(applicationContext, glideBuild, glideBuild.registry);
        }
        if (annotationGeneratedGlideModules != null) {
            annotationGeneratedGlideModules.registerComponents(applicationContext, glideBuild, glideBuild.registry);
        }
