...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f75ix = readShort();
        this.header.currentFrame.f76iy = readShort();
        this.header.currentFrame.f74iw = readShort();
        this.header.currentFrame.f73ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
