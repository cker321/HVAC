...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public RequestBuilder<TranscodeType> mo79clone() {
        ...
        requestBuilder.transitionOptions = requestBuilder.transitionOptions.m80clone();
    ...
    */
    public com.bumptech.glide.request.target.ViewTarget<android.widget.ImageView, TranscodeType> into(android.widget.ImageView r4) {
        /*
            ...
            if (r0 == 0) goto L4c
            int[] r0 = com.bumptech.glide.RequestBuilder.C04131.$SwitchMap$android$widget$ImageView$ScaleType
        ...
        L27:
            goto L4c
        L28:
            com.bumptech.glide.request.BaseRequestOptions r0 = r3.mo79clone()
    ...
    private Priority getThumbnailPriority(Priority priority) {
        int i = C04131.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (i == 1) {
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int i, int i2, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        if (requestBuilder != null) {
            ...
            Request requestObtainRequest = obtainRequest(target, requestListener, baseRequestOptions, thumbnailRequestCoordinator, transitionOptions, priority, i, i2, executor);
            this.isThumbnailBuilt = true;
            RequestBuilder requestBuilder2 = (RequestBuilder<TranscodeType>) this.thumbnailBuilder;
            Request requestBuildRequestRecursive = requestBuilder2.buildRequestRecursive(target, requestListener, thumbnailRequestCoordinator, transitionOptions2, priority2, i3, i4, requestBuilder2, executor);
