...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f70CR = 13;

    /* renamed from: LF */
    private static final byte f71LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f72in;
    private int pos;
    ...
    */
    public java.lang.String readLine() throws java.io.IOException {
        /*
            r7 = this;
            java.io.InputStream r0 = r7.f72in
            monitor-enter(r0)
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f72in;
        byte[] bArr = this.buf;
