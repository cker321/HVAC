...
public class ChinaDate {
    ...
    private final long[] Lunar(int i, int i2) {
        ...
        jArr[0] = i3;
        jArr[3] = i3 - 1864;
        int iLeapMonth = leapMonth(i3);
        jArr[6] = 0;
        int i4 = 1;
        while (i4 < 13 && time > 0) {
            if (iLeapMonth > 0 && i4 == iLeapMonth + 1 && jArr[6] == 0) {
                i4--;
                jArr[6] = 1;
                iMonthDays = leapDays((int) jArr[0]);
            } else {
                iMonthDays = monthDays((int) jArr[0], i4);
            }
            iLYearDays = iMonthDays;
            if (jArr[6] == 1 && i4 == iLeapMonth + 1) {
                jArr[6] = 0;
            }
            time -= iLYearDays;
            if (jArr[6] == 0) {
        ...
        if (time == 0 && iLeapMonth > 0 && i4 == iLeapMonth + 1) {
            if (jArr[6] == 1) {
                jArr[6] = 0;
            } else {
                jArr[6] = 1;
    ...
    public static final long[] calElement(int i, int i2, int i3) {
        ...
        while (i5 < 13 && time > 0) {
            if (iLeapMonth > 0 && i5 == iLeapMonth + 1 && jArr[6] == 0) {
                ...
                j2 = time;
                iMonthDays = monthDays((int) jArr[0], i5);
            }
            if (jArr[6] == 1 && i5 == iLeapMonth + 1) {
                jArr[6] = 0;
            }
            long j3 = j2 - iMonthDays;
            if (jArr[6] == 0) {
                jArr[4] = jArr[4] + 1;
            }
            i5++;
        ...
        long j4 = time;
        if (j4 == 0 && iLeapMonth > 0 && i5 == iLeapMonth + 1) {
            if (jArr[6] == 1) {
                jArr[6] = 0;
            } else {
                jArr[6] = 1;
