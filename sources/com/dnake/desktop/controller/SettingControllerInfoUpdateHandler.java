...
public final class SettingControllerInfoUpdateHandler extends MappingHandler {
    private Object mHost;

    public SettingControllerInfoUpdateHandler(Object obj, Mapping mapping, Addition addition, CrossOrigin crossOrigin) {
    ...
    protected View onHandle(HttpRequest httpRequest, HttpResponse httpResponse) throws Throwable {
        ...
        return new ObjectView(true, ((SettingController) this.mHost).infoUpdate());
    }
}
